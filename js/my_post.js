...
const get_total_count = () => {
    ...
    $.post(api_url + "/get_my_posts_count", { email: email, filter: filter }, function (data, status) {
                   ...
                   <div class="card-body p-0 position-relative">
                      ...
                      <div class="blog-description1 px-2 py-2" style="position:relative">
                         ...
                         <div
                            ...
                            <div class="card-post-toolbar delete_dropdown">
                                <div class="dropdown">
                                   ...
                                   <div class="dropdown-menu m-0 p-0">
                                      <a class="dropdown-item p-3" href="#">
                                         <div class="delete d-flex align-items-center">
                                            <i class="material-symbols-outlined pe-2 md-18">delete</i>delete
                                         </div>
                                      </a>
                                   </div>
                                </div>
